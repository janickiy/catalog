...
class HomeController extends Controller
{
    ...
    public function index(Request $request, $id = 0)
    {
        ...
        return view('index', compact('arr','number', 'links', 'id'))->with('title','Каталог сайтов');
    }
    ...
    public function info($id)
    {
        ...
        if ($link) {
            ...
            return view('info', compact('link'))->with('title',$link->name);
        }
    ...
    public function addurl()
    {
        ...
        return view('addurl', compact('options'))->with('title','Добавить сайт');
    }
